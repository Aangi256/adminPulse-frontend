                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className={`max-w-[65%] ${isMine ? "items-end" : "items-start"} flex flex-col`}>
                                            ...
                                            <div
                                                className={`px-3 py-2 rounded-2xl text-sm shadow-sm ${isMine
            ...
            <div className="px-4 py-3 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
                <div className="flex items-center gap-3 bg-gray-100 dark:bg-gray-700 rounded-full px-4 py-2">
                    ...
                    <button
                        ...
                        className={`flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-full transition-colors ${newMessage.trim()
